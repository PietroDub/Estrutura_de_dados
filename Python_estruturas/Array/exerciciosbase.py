...
# Copie, cole no seu editor e resolva! Soluções no final. Use list comprehension sempre que possível. List comprehension = map + filter (mais Pythonic)
...
nums = reduce(lambda l, y: l * y, nums)
print(nums)
